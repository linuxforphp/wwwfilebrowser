...
$baseConfig['view'] = [
    ...
    'lightmvc_logo' => $baseConfig['URLBASEADDR'] . 'img/linuxforphp_logo.png',
    'lightmvc_logo_large' => $baseConfig['URLBASEADDR'] . 'img/linuxforphp_logo_large.png',
    'favicon' => $baseConfig['URLBASEADDR'] . 'favicon.ico',
    'appname' => $baseConfig['appName'],
    'title' => 'FileBrowser Homepage',
